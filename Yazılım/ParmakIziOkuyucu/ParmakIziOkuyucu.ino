/***************************************************
  Parmak İzi Sensörü ile Servo Motor Kontrolü
  Bu çalışma örnek teşkil etmekte olup tanımlamalar, atamalar, void setup ve getFingerprintIDez() fonksiyonu içerisindeki ilgili yerleri
  projenize uygun olarak değiştirerek kullanabilirsiniz.

  İletişim ve sipariş için:
  https://www.instagram.com/elektronikhobi/ sayfasını takip edip mesaj atabilir veya elektronikhobi@outlook.com adresine mail atabilirsiniz.
 ****************************************************/
...
int getFingerprintIDez() {
  ...
  // Bu kısımda projenize uygun değişikliği yapabilirsiniz.
